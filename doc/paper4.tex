...
\lstdefinelanguage{turtle}
{
  ...
  morekeywords={acte, dcterms, owl, rdfs, rdf, schema, reg, skos, xsd, sh},
  % -------------------------- rdfType
  classoffset=2,
